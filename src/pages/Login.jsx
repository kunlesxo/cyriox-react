      ...
      <main className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-12 bg-slate-950">
        ...
        >
          <motion.div variants={itemVariants} className="mb-8 text-center">
            ...
            <p className="text-gray-200 mt-2">Login With Us</p>
          </motion.div>
          ...
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            <motion.div variants={itemVariants} className="mt-6 text-sm font-medium flex justify-center space-x-4">
              ...
              <a href="/signup" className="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200">Don't have an account? Sign up</a>
            </motion.div>
          </form>
        </motion.div>
      </main>
